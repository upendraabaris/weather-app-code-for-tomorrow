...
app.post("/analytics/cities", async (req, res) => {
    try{
        ...
        for (let city of cities) {
            ...
            // await client.query('INSERT INTO city_weather(city, temprature, created_at) VALUES ($1,$2,$3)', [city, temp, NOW()]);
            console.log(weather)
        }
        res.json({
...
app.get("/citystar",(req,res)=>{
    const result = client.query('SELECT * FROM city_weather');
    res.json(result);
    }
)
